    ...
    <div className={`sidebar ${sidebar ? "" : "small-sidebar"}`}>
      ...
      <div className="subscribed-list">
        ...
        <div className="side-link">
          <img src={beyonce} alt="" /> <p>Beyonce</p>
        </div>
        <div className="side-link">
          <img src={Walter} alt="" /> <p>Walter White</p>
        </div>
        <div className="side-link">
          <img src={joker} alt="" /> <p>Joker</p>
        </div>
        <div className="side-link">
          <img src={jon} alt="" /> <p>Jon Snow</p>
        </div>
        <div className="side-link">
          <img src={david} alt="" /> <p>David Beckham</p>
        </div>
      </div>
    </div>
  );
